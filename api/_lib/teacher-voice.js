...
const VOICE_MESSAGES = {
  ...
  study_new_recall: 'New recall. Read the English meaning. Do not listen again first. Try to remember the Russian sentence you just heard. If nothing comes, say I do not remember, then reveal and mark Again.',
  study_review: 'Review. Read the English meaning. Do not listen first. Try to remember the Russian translation from memory. If nothing comes, say I do not remember, then reveal and mark Again.',
  study_delayed_recall: 'Delayed recall. Read the English meaning. Do not listen first. Try to remember the Russian sentence you studied earlier. If nothing comes, say I do not remember, then reveal and mark Again.',
  ...
  teacher_try_recall: 'Try recall first. Say the Russian quietly, type what you remember, or say I do not remember if nothing comes. Then I can reveal.',
