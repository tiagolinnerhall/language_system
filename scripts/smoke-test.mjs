...
const publicPages = ['index.html', 'pricing.html', 'attribution.html', 'terms.html', 'privacy.html', 'refund.html', 'contact.html', 'app.html'];
...
assertIncludes('pricing.html', pricing, 'Public paid checkout is paused');
