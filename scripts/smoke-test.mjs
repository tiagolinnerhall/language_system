...
assertIncludes('app.html', app, 'Start Live Mic');
...
assertIncludes('app.html', app, 'Live Teacher is listening. Ask a question naturally');
assertIncludes('app.html', app, 'function teacherIsListeningCheck');
assertIncludes('app.html', app, 'Yes, I am listening.');
assertIncludes('app.html', app, 'function syncTeacherRecognitionLanguage');
assertIncludes('app.html', app, 'teacherTranscriptEchoesTeacher');
assertIncludes('app.html', app, 'teacherQueuedAiRequests');
assertIncludes('app.html', app, 'teacherAutopilotActionBlockedUntil');
...
assertNotIncludes('app.html', app, 'Using browser voice');
assertNotIncludes('app.html', app, 'falls back to browser voice');
