...
assertIncludes('app.html', app, 'Hear lesson guide');
...
assertIncludes('app.html', app, 'The teacher voice is AI-generated');
assertIncludes('app.html', app, 'Start with Study');
assertIncludes('app.html', app, 'New sentences now');
assertIncludes('app.html', app, 'Teacher Mode voice commands are optional');
