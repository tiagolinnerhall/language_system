...
mustInclude('api/progress.js', 'restoreProgressSnapshot');
mustInclude('api/progress.js', 'archiveId');
mustInclude('api/progress.js', 'baseRevision');
...
mustInclude('api/_lib/store.js', 'restoreProgressSnapshot');
mustInclude('api/_lib/store.js', 'archiveId');
mustInclude('api/_lib/store.js', 'baseRevision');
mustInclude('api/_lib/store.js', 'revision: baseRevision');
...
mustInclude('app.html', 'Cloud history');
mustInclude('app.html', 'cloudHistoryPanel');
mustInclude('app.html', 'cloud-history-quick');
mustInclude('app.html', 'showCloudProgressHistory');
mustInclude('app.html', 'restoreCloudProgressRevision');
mustInclude('app.html', 'storedCloudProgressRevision');
mustInclude('app.html', 'baseRevision');
mustInclude('app.html', 'archiveId');
mustInclude('app.html', 'local_reset_only');
mustInclude('app.html', 'restoreRevision');
mustInclude('app.html', 'restoreConflict');
