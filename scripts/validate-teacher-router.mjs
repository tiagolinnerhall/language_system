...
mustInclude('app.html', app, 'function teacherButtonQuestionSignal');
mustInclude('app.html', app, 'function teacherCurrentButtonAnswer');
...
mustInclude('app.html', app, 'teacherGuideScheduleId');
mustInclude('app.html', app, 'function teacherCancelPendingAi');
